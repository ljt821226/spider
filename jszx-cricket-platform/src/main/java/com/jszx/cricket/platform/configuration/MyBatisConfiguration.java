...
import com.jszx.cricket.platform.expand.mybatis.cache.RedisCache;
import com.jszx.cricket.platform.expand.mybatis.interceptor.PageInterceptor;
import com.jszx.cricket.platform.expand.mybatis.interceptor.ParamInterceptor;
import com.jszx.cricket.platform.expand.mybatis.interceptor.ResultInterceptor;
import com.jszx.cricket.platform.expand.mybatis.type.CommonTypeHandler;
import com.jszx.cricket.platform.expand.mybatis.wrapper.EntityWrapperFactory;
...
public class MyBatisConfiguration {
	...
	private void buildDataBaseEntity(DataSource dataSource, DatabaseEntity dbEntity) throws SQLException {
		...
		try {
			if (switcherProperty.isDatabase()) {
