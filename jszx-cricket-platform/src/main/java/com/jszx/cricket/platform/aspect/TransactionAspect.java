...
import com.jszx.cricket.platform.tool.KeyTool;
...
public class TransactionAspect {
	 ...
	 */
	@Pointcut("execution(public * com..module.service.impl..*ServiceImpl.*(..)) && @annotation(com.jszx.cricket.platform.annotation.TransactionLauncher)")
